...
export function PlayerCard({
  ...
  return <Card className="overflow-hidden card-shadow hover:card-shadow-lg transition-all duration-300 cursor-pointer group" onClick={onClick}>
      <CardContent className="p-0">
        <div className="relative">
          {player.profile_picture_url ? <img src={player.profile_picture_url} alt={player.name} className="w-full h-48 group-hover:scale-105 transition-transform duration-300 border-0 object-contain" /> : <div className="w-full h-48 bg-muted flex items-center justify-center">
        ...
        <div className="p-4 space-y-3">
          ...
          {showStats && <>
              {/* Batting Stats */}
              {isBatsman && <div className="pt-2 border-t">
              ...
              {/* Bowling Stats */}
              {isBowler && <div className="pt-2 border-t">
                  <p className="text-xs font-medium text-muted-foreground mb-2 flex items-center gap-1">
              ...
              {!isBatsman && !isBowler && <div className="grid grid-cols-3 gap-2 pt-2 border-t">
                  <div className="text-center">
                    <p className="text-xs text-muted-foreground">Matches</p>
          ...
          {player.base_price && <div className="pt-2 border-t">
