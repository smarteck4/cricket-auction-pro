...
import { Gavel, Loader2, Eye, EyeOff } from 'lucide-react';
import { z } from 'zod';
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <Card className="neu-convex border-0">
          <CardHeader>
            ...
            <CardDescription>
              Sign in or create an account to participate in auctions
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <TabsContent value="signup">
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <p className="text-xs text-center text-muted-foreground">
                    New accounts are created as spectators. Contact admin to become an owner.
                  </p>
                </form>
              </TabsContent>
            </Tabs>
